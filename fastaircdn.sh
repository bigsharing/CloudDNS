...
record_name="00011c"    #自动更新的二级域名前缀,例如cloudflare的cdn用00011c，gcore的cdn用00011g，后面是数字，程序会自动添加。二级域名需要已经在域名管理网站配置完成，视频教程可以参考：https://www.youtube.com/channel/UCfSvDIQ8D_Zz62oAd5mcDDg
